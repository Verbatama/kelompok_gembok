    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New Admin</h1>
            </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-slate-600">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="time" name="check_in_limit" id="check_in_limit" value="{{ old('check_in_limit') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-slate-500 dark:bg-slate-600 dark:text-white rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent @error('check_in_limit') border-red-500 dark:border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="time" name="bonus_check_out_mulai" id="bonus_check_out_mulai" value="{{ old('bonus_check_out_mulai') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-slate-500 dark:bg-slate-600 dark:text-white rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent @error('bonus_check_out_mulai') border-red-500 dark:border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="time" name="bonus_check_out_selesai" id="bonus_check_out_selesai" value="{{ old('bonus_check_out_selesai') }}" class="w-full px-4 py-3 border border-gray-300 dark:border-slate-500 dark:bg-slate-600 dark:text-white rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent @error('bonus_check_out_selesai') border-red-500 dark:border-red-500 @enderror">
