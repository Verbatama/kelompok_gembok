            ...
            <div class="p-6">
                ...
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span
                            class="px-4 py-2 rounded-lg bg-{{ $badge['color'] }}-100 text-{{ $badge['color'] }}-800 font-medium">{{ $badge['label'] }}</span>
                    </div>
                </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6">
                            <h3 class="text-lg font-bold text-gray-900 mb-4"><i
                                    class="fas fa-user mr-2 text-cyan-600"></i>Data Pelanggan</h3>
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">
                                        <a href="https://wa.me/{{ preg_replace('/^0/', '62', $order->customer_phone) }}"
                                ...
                                <div class="col-span-2">
                                    ...
                                    @if($order->latitude && $order->longitude)
                                        <a href="https://maps.google.com/?q={{ $order->latitude }},{{ $order->longitude }}"
                                            target="_blank" class="text-sm text-cyan-600 hover:underline">
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6">
                            <h3 class="text-lg font-bold text-gray-900 mb-4"><i
                                    class="fas fa-box mr-2 text-cyan-600"></i>Detail Paket</h3>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">Rp {{ number_format($order->package_price, 0, ',', '.') }}/bulan
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6">
                            <h3 class="text-lg font-bold text-gray-900 mb-4"><i
                                    class="fas fa-credit-card mr-2 text-cyan-600"></i>Pembayaran</h3>
                            @php $payBadge = $order->payment_status_badge; @endphp
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-sm text-gray-500">Status</p>
                                    <span
                                        class="px-2 py-1 text-xs rounded-full bg-{{ $payBadge['color'] }}-100 text-{{ $payBadge['color'] }}-800">{{ $payBadge['label'] }}</span>
                                </div>
                                <div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p class="text-2xl font-bold text-cyan-600">Rp
                        ...
                        @if($order->customer_notes)
                            <div class="bg-white rounded-xl shadow-md p-6">
                                <h3 class="text-lg font-bold text-gray-900 mb-4"><i
                                        class="fas fa-sticky-note mr-2 text-cyan-600"></i>Catatan Pelanggan</h3>
                    ...
                    <div class="space-y-6">
                            ...
                            <form id="statusForm" class="space-y-4">
                                <div>
                                    ...
                                    <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                                        ...
                                        <option value="confirmed" {{ $order->status == 'confirmed' ? 'selected' : '' }}>
                                            Dikonfirmasi / Confimed</option>
                                        <option value="scheduled" {{ $order->status == 'scheduled' ? 'selected' : '' }}>
                                            Dijadwalkan / Scheduled</option>
                                        <option value="installing" {{ $order->status == 'installing' ? 'selected' : '' }}>
                                            Pemasangan / Installing</option>
                                        <option value="completed" {{ $order->status == 'completed' ? 'selected' : '' }}>
                                            Selesai / Completed</option>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="installation_date"
                                        value="{{ $order->installation_date?->format('Y-m-d') }}"
                                ...
                                <div>
                                    ...
                                    <textarea name="admin_notes" rows="2"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg">{{ $order->admin_notes }}</textarea>
                                </div>
                                <button type="submit"
                        ...
                        <div class="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <a href="https://wa.me/{{ preg_replace('/^0/', '62', $order->customer_phone) }}"
                                    target="_blank"
                                    class="block w-full bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 text-center">
                        ...
                        @if($order->customer_id)
                            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                                <p class="text-green-800 font-medium"><i class="fas fa-check-circle mr-2"></i>Sudah jadi
                                    pelanggan</p>
                                <a href="{{ route('admin.customers.show', $order->customer_id) }}"
                                    class="text-sm text-green-600 hover:underline">Lihat data pelanggan →</a>
                            </div>
                        @endif
                    </div>
                </div>
