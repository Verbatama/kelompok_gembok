            ...
            <div class="p-6">
                    ...
                    <div class="bg-cyan-50 rounded-xl p-4 border border-cyan-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-gray-500">Installing</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-4 mb-6">
                    <form method="GET" class="flex flex-wrap gap-4">
                        ...
                        <select name="status"
                            class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500">
                            ...
                            <option value="installing" {{ request('status') == 'installing' ? 'selected' : '' }}>Pemasangan
                            </option>
                        ...
                        <select name="payment_status"
                            ...
                            <option value="pending" {{ request('payment_status') == 'pending' ? 'selected' : '' }}>Belum Bayar
                            </option>
                        ...
                        <a href="{{ route('admin.orders.index') }}"
                            class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">Reset</a>
                    </form>
                </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Pelanggan
                                    </th>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Pembayaran
                                    </th>
        ...
        @push('scripts')
                ...
                function confirmPayment(orderId) {
                    Swal.fire({
                       ...
                       reve rseButtons: true
                  }).then(  (result) => {
                      if (resu  lt.isConfirmed) {
                         show   Loading('Memproses...');
