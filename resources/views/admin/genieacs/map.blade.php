{{-- @vite([
'resources/js/map/Leaflet.Editable.js',
'resources/js/map/map-utils.js',
'resources/js/map/map-core.js',
'resources/js/map/map-markers.js',
'resources/js/map/map-polylines.js',
'resources/js/map/map-items.js',
'resources/js/map/map-server.js',
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-secondary" id="fullscreen-toggle" onclick="toggleFullscreen()" title="Fullscreen">
...
{{-- gak perlu file edit bawaan GenieACS Dsh --}}
{{-- <script src="{{ asset('assets/js/map/Leaflet.Editable.js') }}"></script> --}}
<script src="{{ asset('assets/js/map/map-utils.js') }}"></script>
<script src="{{ asset('assets/js/map/map-core.js') }}"></script>
<script src="{{ asset('assets/js/map/map-markers.js') }}"></script>
<script src="{{ asset('assets/js/map/map-polylines.js') }}"></script>
<script src="{{ asset('assets/js/map/map-items.js') }}"></script>
<script src="{{ asset('assets/js/map/map-server.js') }}"></script>
<script>
      window.APP = {
...
@endpush
@vite([ 'resources/js/app.js', 'resources/css/app.css', 'resources/js/map.js'])