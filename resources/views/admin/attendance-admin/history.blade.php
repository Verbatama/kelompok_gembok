...
<div class="min-h-screen bg-gray-100 dark:bg-slate-800 transition-colors duration-300" x-data="{
    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            ...
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Riwayat Absensi Admin</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Pantau kehadiran dan keterlambatan seluruh admin</p>
            </div>
            ...
            <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md p-5 mb-6">
                <form method="GET" action="{{ route('admin.attendance-admin.history') }}" class="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Cari Admin</label>
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama admin..." class="w-full rounded-lg border border-gray-300 dark:border-slate-500 bg-white dark:bg-slate-600 text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500">
                    </div>
                    <div class="flex items-end gap-2">
                        ...
                        <a href="{{ route('admin.attendance-admin.history') }}" class="flex-1 text-center bg-gray-200 hover:bg-gray-300 dark:bg-slate-600 dark:hover:bg-slate-500 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg text-sm font-medium transition">
                            Reset
                        </a>
                    </div>
                </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-600">
                        <thead class="bg-gray-50 dark:bg-slate-600">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Nama Admin</th>
                        ...
                        <tbody class="bg-white dark:bg-slate-700 divide-y divide-gray-200 dark:divide-slate-600">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-600/50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <span class="px-2.5 py-1 text-xs font-semibold rounded-full bg-black text-white">
                                        <i class="fas fa-sign-out-alt mr-1"></i> Tidak Masuk
                                    </span>
                                    @elseif ($history->status === 'check-in')
