...
@section('title', 'Riwayat Pengajuan Libur Admin')
    ...
    <div class="lg:pl-64">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between flex-wrap gap-3 mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Riwayat Pengajuan Libur Admin</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Khusus superadmin — daftar pengajuan libur, izin, dan sakit seluruh admin</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md p-5 mb-6">
                <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Admin</label>
                        <select name="user_id" class="w-full rounded-lg border border-gray-300 dark:border-slate-500 bg-white dark:bg-slate-600 text-gray-900 dark:text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500">
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="{{ route('admin.riwayat-libur-admin.index') }}" class="flex-1 text-center bg-gray-200 hover:bg-gray-300 dark:bg-slate-600 dark:hover:bg-slate-500 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg text-sm font-medium transition">
                            Reset
                        </a>
                    </div>
                </form>
            ...
            <div class="bg-white dark:bg-slate-700 rounded-xl shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-600 flex items-center justify-between">
                    <p class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                        <i class="fas fa-user-shield mr-1.5 text-cyan-600 dark:text-cyan-400"></i> Daftar Pengajuan Libur Admin
                    </p>
                ...
                <div class="divide-y divide-gray-200 dark:divide-slate-600">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900 dark:text-white">
                                            {{ $leave->user->name ?? 'Admin tidak ditemukan' }}
                                        </p>
                    ...
                    @empty
                        <div class="p-12 text-center text-gray-500 dark:text-gray-400">
                            ...
                            <p class="text-sm">Belum ada pengajuan libur admin</p>
                        </div>
                    @endforelse
                </div>
