    ...
    <div class="min-h-screen bg-gray-100 dark:bg-slate-900 p-6 md:ml-64">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.payroll.create') }}"
                class="px-5 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold transition">
                + Proses Payroll
            </a>
                        ...
                        @forelse($payrolls as $payroll)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                                ...
                                <td class="px-5 py-4 text-center">
                                    {{ sprintf('%02d', $payroll->bulan) }}/{{ $payroll->tahun }}
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a href="{{ route('technician-payrolls.show', $payroll) }}"
                                            class="px-3 py-1 rounded bg-sky-500 text-white text-sm">
                                            Detail
                                        </a>


                                        <a href="{{ route('technician-payrolls.edit', $payroll) }}"
                                            class="px-3 py-1 rounded bg-amber-500 text-white text-sm">
                                            Edit
                                        </a>


                                        <form action="{{ route('technician-payrolls.destroy', $payroll) }}" method="POST">

                                            @csrf
                                            @method('DELETE')

                                            <button onclick="return confirm('Hapus payroll ini?')"
