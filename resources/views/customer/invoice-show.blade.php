        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="flex justify-between items-start mb-6 pb-6 border-b">
                ...
                <div class="text-right">
                    <span
                        class="px-3 py-1 rounded-full text-sm font-semibold {{ $invoice->status === 'paid' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700' }}">
            ...
            @if($invoice->status === 'unpaid')
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="space-y-4" id="paymentMethods">
                            ...
                            <div>
                                ...
                                <button type="button" onclick="selectPayment('SP')"
                                    class="w-full flex items-center p-4 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <button type="button" onclick="selectPayment('BC')"
                                        class="flex items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                        <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                            <span class="text-blue-600 font-bold text-xs">BCA</span>
                                        </div>
                                        <span class="font-medium text-gray-900 text-sm">BCA</span>
                                    </button>
                                    <button type="button" onclick="selectPayment('M2')"
                                        class="flex items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    ...
                                    <button type="button" onclick="selectPayment('I1')"
                                        class="flex items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    ...
                                    <button type="button" onclick="selectPayment('BR')"
                                        class="flex items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                        <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    <button type="button" onclick="selectPayment('OV')"
                                        class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    ...
                                    <button type="button" onclick="selectPayment('DA')"
                                        class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                                    ...
                                    <button type="button" onclick="selectPayment('SA')"
                                        class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-xl hover:border-cyan-500 hover:bg-cyan-50 transition">
                ...
                @else
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <p class="text-yellow-800">Pembayaran online belum tersedia. Silakan hubungi admin untuk informasi
                            pembayaran.</p>
                    </div>
                @endif
            @else
