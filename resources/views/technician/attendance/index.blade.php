...
@section('content')
<!-- Leaflet CSS & Custom Styles langsung dimasukkan ke dalam content agar pasti termuat -->
...
<div style="max-width:960px;margin:0 auto;padding:1.5rem 1rem;">
    ...
    <div style="margin-bottom:1.5rem;">
        <h1 style="font-size:22px;font-weight:700;color:#111827;margin:0;">Absensi Teknisi</h1>
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
            ...
            <div class="card">
                ...
                <div style="margin-bottom:12px;">
                    <span class="s-badge {{ $sudahCheckout ? 'selesai' : ($sudahCheckin ? 'masuk' : 'belum') }}">
                ...
                <div class="info-row">
                    ...
                    <span class="val">{{ $technician->name ?? '-' }}</span>
                </div>
                <div class="info-row">
...
{{-- Form — field name sesuai controller Portal --}}
<form id="form-absensi" method="POST" action="{{ route('technician.attendance.store') }}" style="display:none;">
    @csrf
...
<!-- Leaflet JS & Logika Script ditaruh di dalam section content agar tereksekusi dengan baik -->
