                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $customer->customer_address }}</p>
                                    <p class="text-xs text-gray-400 mt-1">
                                        <i
                                            class="fas fa-box mr-1"></i>{{ $package_customer = \App\Models\Package::find($customer->package_id)?->name ?? 'N/A' }}
                                    </p>
                                </div>
                            </div>
                            <div class="text-right">
                                ...
                                <div class="mt-2 space-x-2">
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $customer->customer_phone) }}"
                                        target="_blank" class="text-green-600 hover:text-green-700 text-sm">
                                        <i class="fab fa-whatsapp mr-1"></i> WA
                                    </a>
                                    <a href="https://maps.google.com/?q={{ $customer->latitude }},{{ $customer->longitude }}"
                                        target="_blank" <i class="fas fa-map-marker-alt mr-1"></i> Map
